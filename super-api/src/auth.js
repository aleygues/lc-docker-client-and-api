...
var customAuthChecker = function (_a) {
    var root = _a.root, args = _a.args, context = _a.context, info = _a.info;
    return __awaiter(void 0, void 0, void 0, function () {
        var userRepo, userJwt, decoded, user, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    userRepo = (0, typeorm_1.getRepository)(User_1.User);
                    userJwt = context.token;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    decoded = jwt.verify(userJwt, 'supersecret');
                    if (!decoded.userId) {
                        return [2 /*return*/, false];
                    }
                    return [4 /*yield*/, userRepo.findOne(decoded.userId)];
                case 2:
                    user = _b.sent();
                    if (!user) {
                        return [2 /*return*/, false];
